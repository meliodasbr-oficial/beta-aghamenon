...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const avisosDoServidor = [
        { titulo: 'Aghamenon Toberlock Estudos', mensagem: ' É um site criado por um estudante do ensino médio, com o objetivo de ajudar outros estudantes e adultos que gostam de estudos.' },
        { titulo: 'Fora do Ar', mensagem: 'Abertura dia 12/08/2024 ás 09:00h (horário de brasília).' }
    ];
